...
***
  ...
  - [Установка самого запрета](#установка-самого-запрета)
  - [Сама программа](#сама-программа)
  - [Далее настройка и применение блокчека](#далее-настройка-и-применение-блокчека)
...
Далее берём соответственно стратегию которую нам подобрал блокчек
>* SUMMARY
>
